...
To further evaluste the performance of the model a confusion matrix and a classification report was generated.
For the 0's(healthy loans) we have 100% for the precision, Recall and F1 score.
while for the 1's (high-risk loan) we have 87% for the precision core, 89% for the Recall and 88% for the F1 score.the 1's have a lower precisions and Recalls because of the presence of False positives and false negatives.
